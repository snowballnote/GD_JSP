...
<%
	...
	//파일 저장시 원본이름을 사용하면 덮어쓰기 이슈 - 저장에 사용할 파일이름 생성
	...
	//업로드된 원본이름에서 파일 확장자만(마지막.의 세글자) 분리
	String originName = part.getSubmittedFileName(); //디버깅
	...
	//웹프로젝트안에 폴더의 실제경로(path)를 구하는 api
